...
function ChartTooltip({ active, payload, label }: any) {
    ...
    const formatDate = (dateStr: string) => {
        if (!dateStr || dateStr.includes(' - ') || !/^\d{4}-\d{2}-\d{2}/.test(dateStr)) return dateStr
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            <div className="grid grid-cols-3 divide-x divide-gray-200">
                ...
                >
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {activeEventTypes.has('clicks') && <Check className="w-4 h-4 text-violet-500" />}
                    </div>
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {activeEventTypes.has('leads') && <Check className="w-4 h-4 text-violet-500" />}
                    </div>
                    <p className="text-4xl font-bold text-gray-900 tracking-tight">
                ...
                >
                    <div className="absolute right-4 top-4 flex items-center gap-2">
                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                            <button
                                onClick={(e) => { e.stopPropagation(); setSaleUnit('currency') }}
                            ...
                            <button
                                onClick={(e) => { e.stopPropagation(); setSaleUnit('count') }}
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {activeEventTypes.has('sales') && <Check className="w-4 h-4 text-violet-500" />}
                    </div>
                    <p className="text-4xl font-bold text-gray-900 tracking-tight">
                        <NumberFlow
                            ...
                            {RANGE_OPTIONS.map(opt => (
                                <button
                                    ...
                                    className={`px-2.5 py-2 text-xs font-medium transition-colors ${
                                        selectedDays === opt.days ? 'bg-gray-100 text-gray-900' : 'text-gray-400 hover:bg-gray-50'
                                    }`}
                                >
                                    {opt.label}
                                </button>
            ...
            <style jsx>{`
                @keyframes funnelGrow {
                    from { opacity: 0.3; transform: scaleY(0.02); }
